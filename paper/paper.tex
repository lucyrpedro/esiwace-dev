...
The user can access both file systems as a work and scratch file system.
While data is kept on the work file system indefinitely its available space is limited by a quota.
The scratch file system allows to store more data but data is automatically deleted after a period of time.
...
\Cref{fig:lifecycle} shows three possible life cycles for a specific dataset and the access pattern to the dataset.
