...
Firstly, the IO scheduler could make the placement decision for the individual data sets and manage their relocation during the life cycle as discussed in \Cref{sec:datamanagement}.
...
The relevant software stack involved in executing a workflow with our IO-aware scheduler is depicted in \Cref{fig:stages-io}.
